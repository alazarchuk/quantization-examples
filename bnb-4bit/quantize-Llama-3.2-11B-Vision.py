import torch
from transformers import AutoTokenizer, MllamaForConditionalGeneration, BitsAndBytesConfig
...
quant_path = "Llama-3.2-11B-Vision-bnb-4bit"
...
model = MllamaForConditionalGeneration.from_pretrained(model_name, quantization_config=bnb_config)
